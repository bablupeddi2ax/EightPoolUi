...
class ChildAdapter(val context: Context, private var innerItems: List<Item>) :
    RecyclerView.Adapter<ChildAdapter.InnerViewHolder>() {
    interface OnItemClickedListenerC {
        fun onItemClicked(item: Item)
    }
     var itemClickListener: OnItemClickedListenerC? = null

    fun setOnItemClickListener(listener: OnItemClickedListenerC) {
        ...
        init {
            itemView.setOnClickListener {
                ...
                if (position != RecyclerView.NO_POSITION) {
                    ...
                    itemClickListener?.onItemClicked(clickedItem)
                }
            }
        }
...
//            Log.i("childadpeer onitemclick","inside onitemclickedlsiterM")
//        }
//    }
